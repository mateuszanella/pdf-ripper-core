...
/// Raw in-memory dump document save strategy.
///
...
/// or invalid dictionary structures are serialised verbatim — it is the caller's
...
class raw_document_save_strategy final : public document_save_strategy
{
public:
