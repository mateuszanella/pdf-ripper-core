...
{
public:
    explicit io_exception(std::string message) : exception(std::move(message)) {}
};
...
{
public:
    explicit parse_exception(std::string message) : exception(std::move(message)) {}
};
...
{
public:
    explicit logic_exception(std::string message) : exception(std::move(message)) {}
};
...
{
public:
    explicit not_implemented_exception(std::string message) : exception(std::move(message)) {}
};
} // namespace ripper::pdf::core
